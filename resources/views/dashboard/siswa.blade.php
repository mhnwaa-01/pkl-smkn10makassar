    ...
    <div class="bg-slate-900 text-white border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm relative overflow-hidden">
        <div class="relative z-10">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mt-4 text-xs text-slate-300 font-medium">
                ...
                <div>
                    <a href="{{ asset('downloads/PKL-SMKN10-Siswa.apk') }}" download="PKL-SMKN10-Siswa.apk" class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full text-xs font-bold transition-all shadow-sm">
